...
RSpec.describe SpeciesController, type: :controller do
  ...
  describe "GET #show" do
    it "returns a success response" do
      species = Species.create! valid_attributes
      get :show, params: {id: species.to_param}, session: valid_session
      expect(response).to be_success
    end
  end
  ...
  describe "GET #edit" do
    it "returns a success response" do
      species = Species.create! valid_attributes
      get :edit, params: {id: species.to_param}, session: valid_session
      expect(response).to be_success
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new Species" do
        expect {
          post :create, params: {species: valid_attributes}, session: valid_session
    ...
    context "with invalid params" do
      it "returns a success response (i.e. to display the 'new' template)" do
        post :create, params: {species: invalid_attributes}, session: valid_session
        expect(response).to be_success
      end
    end
  end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested species" do
        species = Species.create! valid_attributes
        put :update, params: {id: species.to_param, species: new_attributes}, session: valid_session
        species.reload
      ...
      it "redirects to the species" do
        species = Species.create! valid_attributes
        put :update, params: {id: species.to_param, species: valid_attributes}, session: valid_session
    ...
    context "with invalid params" do
      it "returns a success response (i.e. to display the 'edit' template)" do
        species = Species.create! valid_attributes
        put :update, params: {id: species.to_param, species: invalid_attributes}, session: valid_session
        expect(response).to be_success
      end
    end
  end
